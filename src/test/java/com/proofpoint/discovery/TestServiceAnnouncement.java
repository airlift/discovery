...
public class TestServiceAnnouncement
{
    ...
    {
        ServiceAnnouncement announcement = new ServiceAnnouncement(null, "type", "pool", Collections.<String, String>emptyMap());
    ...
    {
        ServiceAnnouncement announcement = new ServiceAnnouncement(UUID.randomUUID(), null, "pool", Collections.<String, String>emptyMap());
    ...
    {
        ServiceAnnouncement announcement = new ServiceAnnouncement(UUID.randomUUID(), "type", null, Collections.<String, String>emptyMap());
    ...
    {
        ServiceAnnouncement announcement = new ServiceAnnouncement(UUID.randomUUID(), "type", "pool", null);
    ...
    private void assertFailedValidation(ServiceAnnouncement announcement, String field, String message, Class<? extends Annotation> annotation)
    {
        Set<ConstraintViolation<ServiceAnnouncement>> violations = VALIDATOR.validate(announcement);
        assertEquals(violations.size(), 1);

        ConstraintViolation<ServiceAnnouncement> violation = violations.iterator().next();
